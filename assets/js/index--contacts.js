...
;// CONCATENATED MODULE: ./source/js/locomotive/locomotive--withoutCircle.js

BrowserDetect.init();

let locomotive_withoutCircle_scroll;
let scrollTop;
...
window.onload = () => {
  ...
  locomotive_withoutCircle_scroll = new LocomotiveScroll({
  ...
  locomotive_withoutCircle_scroll.on("scroll", ({ limit, scroll }) => {
    if (window.innerWidth > 1024) {
      scrollTop = scroll.y;
...
;// CONCATENATED MODULE: ./source/js/indexes/index--contacts.js
