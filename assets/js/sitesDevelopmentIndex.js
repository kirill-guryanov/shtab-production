  ...
  window.addEventListener("load", function () {
    ...
    window.addEventListener("scroll", () => {
      ...
      try {
        ...
        types = document.querySelector(".types").offsetTop;
        clouds = document.querySelector(".clouds").offsetTop;
...
// EXTERNAL MODULE: ./source/js/circle/circle--sitesDevelopment.js
var circle_sitesDevelopment = __webpack_require__(357);
...
;// CONCATENATED MODULE: ./source/js/locomotive/locomotive--sitesDevelopment.js
...
try {
  ...
  window.onload = () => {
    ...
    scroll.on("scroll", ({ limit, scroll }) => {
      ...
      const clouds = document.querySelector(".clouds").offsetTop;
...
;// CONCATENATED MODULE: ./source/js/indexes/sitesDevelopmentIndex.js
// preloader
