  ...
  window.addEventListener("load", function () {
    ...
    window.addEventListener("scroll", () => {
      ...
      try {
        ...
        formats = document.querySelector(".formats").offsetTop;
        cycles = document.querySelector(".cycles").offsetTop;
...
// EXTERNAL MODULE: ./source/js/circle/circle--serm.js
var circle_serm = __webpack_require__(642);
...
;// CONCATENATED MODULE: ./source/js/locomotive/locomotive--serm.js
...
try {
  ...
  window.onload = () => {
    ...
    scroll.on("scroll", ({ limit, scroll }) => {
      ...
      const formats = document.querySelector(".formats").offsetTop;
      const cycles = document.querySelector(".cycles").offsetTop;
      const benefits = document.querySelector(".benefits").offsetTop;
      const costs = document.querySelector(".costs").offsetTop;
...
;// CONCATENATED MODULE: ./source/js/indexes/sermIndex.js
// preloader
