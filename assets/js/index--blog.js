...
// EXTERNAL MODULE: ./source/js/circle/circle--blog.js
var circle_blog = __webpack_require__(362);
...
;// CONCATENATED MODULE: ./source/js/locomotive/locomotive--blog.js
...
try {
  ...
  // window.addEventListener("load", () => {
  //   const thumb = document.querySelector(".c-scrollbar .c-scrollbar_thumb");
  //   console.log(thumb);
  //   if (thumb) {
  //     thumb.style.backgroundColor = "#D0FF48";
  //   }
  // });
} catch (error) {}

;// CONCATENATED MODULE: ./source/js/indexes/index--blog.js
// preloader
