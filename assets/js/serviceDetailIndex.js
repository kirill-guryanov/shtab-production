  ...
  window.addEventListener("load", function () {
    ...
    window.addEventListener("scroll", () => {
      try {
        ...
        const stack = document.querySelector(".stack").offsetTop;
...
// EXTERNAL MODULE: ./source/js/circle/circle--serviceDetail.js
var circle_serviceDetail = __webpack_require__(157);
...
;// CONCATENATED MODULE: ./source/js/locomotive/locomotive--serviceDetail.js
...
;// CONCATENATED MODULE: ./source/js/indexes/serviceDetailIndex.js
// preloader
