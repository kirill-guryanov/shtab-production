  ...
  window.addEventListener("load", function () {
    ...
    window.addEventListener("scroll", () => {
      ...
      try {
        ...
        statistics = document.querySelector(".statistics").offsetTop;
        team = document.querySelector(".team").offsetTop;
        hoisting = document.querySelector(".hoisting").offsetTop;
...
// EXTERNAL MODULE: ./source/js/circle/circle--studio.js
var circle_studio = __webpack_require__(107);
...
;// CONCATENATED MODULE: ./source/js/locomotive/locomotive--studio.js

BrowserDetect.init();

let locomotive_studio_scroll;
let scrollTop;
...
window.onload = () => {
  ...
  locomotive_studio_scroll = new LocomotiveScroll({
  ...
  locomotive_studio_scroll.on("call", (func, args, obj) => {
  ...
  if (window.innerWidth >= 1024) {
    ...
    locomotive_studio_scroll.on("scroll", ({ limit, scroll }) => {
      const animationStarted = new Event("animationStarted");
  ...
  Array.from(circleArrows).forEach((circleArrow) => {
    circleArrow.addEventListener("click", () => {
      locomotive_studio_scroll.scrollTo("top");
    });
  });
  circleArrowsParent.addEventListener("click", () => {
    locomotive_studio_scroll.scrollTo("top");
...
;// CONCATENATED MODULE: ./source/js/indexes/studioIndex.js
// preloader
