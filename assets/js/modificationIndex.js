  ...
  window.addEventListener("load", function () {
    ...
    window.addEventListener("scroll", () => {
      try {
        ...
        const tasks = document.querySelector(".tasks").offsetTop;
        const ready = document.querySelector(".ready").offsetTop;
...
// EXTERNAL MODULE: ./source/js/circle/circle--modification.js
var circle_modification = __webpack_require__(727);
...
;// CONCATENATED MODULE: ./source/js/locomotive/locomotive--modification.js
...
;// CONCATENATED MODULE: ./source/js/indexes/modificationIndex.js
// preloader
